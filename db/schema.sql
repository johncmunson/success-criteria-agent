...
CREATE TABLE public.canvases (
  ...
  CONSTRAINT canvases_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id),
  CONSTRAINT canvases_folder_id_fkey FOREIGN KEY (folder_id) REFERENCES public.folders(id)
);
CREATE TABLE public.evaluations (
  ...
  CONSTRAINT evaluations_requirement_id_fkey FOREIGN KEY (requirement_id) REFERENCES public.requirements(id)
);
CREATE TABLE public.files (
  ...
  CONSTRAINT files_prompt_id_fkey FOREIGN KEY (prompt_id) REFERENCES public.prompts(id)
);
...
CREATE TABLE public.prompts (
  ...
  CONSTRAINT prompts_canvas_version_id_fkey FOREIGN KEY (canvas_version_id) REFERENCES public.canvas_versions(id),
  CONSTRAINT prompts_model_id_fkey FOREIGN KEY (model_id) REFERENCES public.models(id)
);
CREATE TABLE public.requirement_groups (
  ...
  CONSTRAINT requirement_groups_canvas_version_id_fkey FOREIGN KEY (canvas_version_id) REFERENCES public.canvas_versions(id)
);
CREATE TABLE public.requirements (
  ...
  CONSTRAINT requirements_canvas_version_id_fkey FOREIGN KEY (canvas_version_id) REFERENCES public.canvas_versions(id),
  CONSTRAINT requirements_requirement_group_id_fkey FOREIGN KEY (requirement_group_id) REFERENCES public.requirement_groups(id),
  CONSTRAINT requirements_model_id_fkey FOREIGN KEY (model_id) REFERENCES public.models(id)
);
CREATE TABLE public.responses (
  ...
  CONSTRAINT responses_canvas_version_id_fkey FOREIGN KEY (canvas_version_id) REFERENCES public.canvas_versions(id)
);
...
CREATE TABLE public.tools (
  ...
  CONSTRAINT tools_prompt_id_fkey FOREIGN KEY (prompt_id) REFERENCES public.prompts(id)
);
